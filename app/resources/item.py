...
@validate_category
def create_item(category, data, user, category_id):
...
@validate_category
def get_items_by_category_id(category, data, category_id):
...
@validate_item
def get_item_by_id(item, category_id, item_id):
...
@validate_item
@validate_ownership
def update_item_by_id(item, data, user, category_id, item_id):
...
@validate_item
@validate_ownership
def delete_item_by_id(item, user, category_id, item_id):
